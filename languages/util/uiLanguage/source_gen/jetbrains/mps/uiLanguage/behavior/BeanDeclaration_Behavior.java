...
public class BeanDeclaration_Behavior {
  ...
  public static String call_getGeneratedClassFQName_1213877331538(SNode thisNode) {
    return SNodeOperations.getModelLongName(((SModel) jetbrains.mps.lang.smodel.generator.smodelAdapter.SNodeOperations.getModel(thisNode))) + "." + BeanDeclaration_Behavior.call_getGeneratedName_1213877331530(thisNode);
  }
