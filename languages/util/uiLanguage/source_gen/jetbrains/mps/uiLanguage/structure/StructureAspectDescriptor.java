...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 1:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.AddListenerOperation").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("+=", "").create();
      case 2:
      ...
      case 6:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.BeanCreator").super_("jetbrains.mps.baseLanguage.structure.AbstractCreator").parents("jetbrains.mps.baseLanguage.structure.AbstractCreator").references("constructor").children(new String[]{"parameter"}, new boolean[]{true}).alias("bean", "").create();
      case 7:
      ...
      case 8:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.BeanType").super_("jetbrains.mps.baseLanguage.classifiers.structure.BaseClassifierType").parents("jetbrains.mps.baseLanguage.classifiers.structure.BaseClassifierType").references("bean").alias("bean<>", "").create();
      case 9:
      ...
      case 10:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.BindExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"expression"}, new boolean[]{false}).alias("{", "bind expression").create();
      case 11:
      ...
      case 13:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.ComponentCreator").super_("jetbrains.mps.baseLanguage.structure.AbstractCreator").parents("jetbrains.mps.baseLanguage.structure.AbstractCreator").references("componentDeclaration").alias("component", "").create();
      case 14:
      ...
      case 16:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.ComponentReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("component").alias("<{component}>", "").create();
      case 17:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.ComponentType").super_("jetbrains.mps.baseLanguage.classifiers.structure.BaseClassifierType").parents("jetbrains.mps.baseLanguage.classifiers.structure.BaseClassifierType").references("component").alias("component<>", "").create();
      case 18:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.EventAccessOperation").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.classifiers.structure.IMemberOperation").references("event").create();
      case 19:
      ...
      case 20:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.EventHandlerReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("handler").create();
      case 21:
      ...
      case 32:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.RaiseInternalStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").children(new String[]{"argument"}, new boolean[]{false}).alias("raise", "raise this event").create();
      case 33:
      ...
      case 34:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.RemoveListenerOperation").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("-=", "").create();
      case 35:
        return new ConceptDescriptorBuilder("jetbrains.mps.uiLanguage.structure.RenderingObject").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").alias("object", "value to render").create();
      case 36:
