...
public class InlineFormat_Test extends BaseTestCase {
  ...
  public void test_withTimezone() throws Exception {
    ...
    String ddd = DateTimeOperations.print(DateTimeArithmetics.minus((DateTimeOperations.convert(now1, DateTimeZone.forID("Europe/Moscow"))), Period.hours(3)), (MainFormatTable.INSTANCE).getFormatter("time"), null);
