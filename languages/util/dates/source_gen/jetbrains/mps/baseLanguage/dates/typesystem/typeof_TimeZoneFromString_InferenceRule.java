...
public class typeof_TimeZoneFromString_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode timeZone, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1239019325417", true), (SNode) _quotation_createNode_duo6m4_a0a0a(), _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "5293902215864271028", true), (SNode) _quotation_createNode_duo6m4_a0b0a(), false, true, _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_duo6m4_a0a0a() {
  ...
  private static SNode _quotation_createNode_duo6m4_a0b0a() {
    SNode quotedNode_1 = null;
