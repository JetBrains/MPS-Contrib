...
public class typeof_ConvertToJodaDateTimeOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  private static SNode _quotation_createNode_bjq20g_a0a0b() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#2ebbb458-8ebb-481e-a5d7-9e27903323d4#org.joda.time(jetbrains.mps.baseLanguage.dates.runtime/org.joda.time@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~DateTime")));
    return quotedNode_1;
  }
}
