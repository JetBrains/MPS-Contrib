  ...
  public void applyRule(final SNode mathOperation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "2644539331224368532", true), (SNode) new typeof_MathDateTimeOperation_InferenceRule.QuotationClass_a82tzq_a0a0a0().createNode(typeCheckingContext), false, true, _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "2644539331224421754", true), (SNode) new typeof_MathDateTimeOperation_InferenceRule.QuotationClass_a82tzq_a0a1a0().createNode(typeCheckingContext), false, true, _info_12389875345);
    }
