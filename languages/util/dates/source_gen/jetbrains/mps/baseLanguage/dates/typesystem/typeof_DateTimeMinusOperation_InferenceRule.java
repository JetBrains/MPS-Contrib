...
public class typeof_DateTimeMinusOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1213195725472", true), (SNode) _quotation_createNode_iltepn_a0a0a(), _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1213195725479", true), (SNode) _quotation_createNode_iltepn_a0b0a(), false, true, _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1213195725488", true), (SNode) _quotation_createNode_iltepn_a0c0a(), false, true, _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_iltepn_a0a0a() {
  ...
  private static SNode _quotation_createNode_iltepn_a0b0a() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_iltepn_a0c0a() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.DateTimeType", null, null, GlobalScope.getInstance(), false);
    return quotedNode_1;
  }
