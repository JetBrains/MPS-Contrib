...
public class typeof_DateTimeZoneCreator_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode creator, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1238856132700", true), (SNode) _quotation_createNode_hz50x2_a0a0a(), _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1238856167221", true), (SNode) _quotation_createNode_hz50x2_a0b0a(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_hz50x2_a0a0a() {
  ...
  private static SNode _quotation_createNode_hz50x2_a0b0a() {
    SNode quotedNode_1 = null;
