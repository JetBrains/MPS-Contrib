...
public class typeof_ParseExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
    ...
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1892577441204767239", true), (SNode) _quotation_createNode_ypl97d_a0a0a(), true, true, _info_12389875345);
      }
    }
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "7678715681280021116", true), (SNode) _quotation_createNode_ypl97d_a0b0a(), true, true, _info_12389875345);
      }
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1892577441204768371", true), (SNode) _quotation_createNode_ypl97d_a0c0a(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_ypl97d_a0a0a() {
  ...
  private static SNode _quotation_createNode_ypl97d_a0b0a() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_ypl97d_a0c0a() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.DateTimeType", null, null, GlobalScope.getInstance(), false);
    return quotedNode_1;
  }
