...
public class NullOperation_Behavior {
  ...
  public static boolean callSuper_operandCanBeNull_1015544890586290191(SNode thisNode, String callerConceptFqName) {
    return BehaviorManager.getInstance().invokeSuper(Boolean.TYPE, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.dates.structure.NullOperation"), callerConceptFqName, "virtual_operandCanBeNull_323410281720656291", new Class[]{SNode.class}, new Object[]{});
  }
}
