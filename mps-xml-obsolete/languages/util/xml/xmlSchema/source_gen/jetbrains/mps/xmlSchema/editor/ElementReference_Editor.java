...
public class ElementReference_Editor extends DefaultNodeEditor {
  ...
  public static class _Inline_uugm4e_a0a extends InlineCellProvider {
    ...
    private EditorCell createProperty_uugm4e_a0a0(EditorContext editorContext, SNode node) {
      ...
      style.set(StyleAttributes.TEXT_COLOR, 0, StyleRegistry.getInstance().getSimpleColor(ElementReference_Editor._Inline_uugm4e_a0a._StyleParameter_QueryFunction_uugm4e_a1a0a0((editorCell == null ? null : editorCell.getContext()), (editorCell == null ? null : editorCell.getSNode()))));
