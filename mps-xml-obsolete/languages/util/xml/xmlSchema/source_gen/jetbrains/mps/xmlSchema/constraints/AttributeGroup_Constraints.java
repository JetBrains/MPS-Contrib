...
public class AttributeGroup_Constraints extends BaseConstraintsDescriptor {
  public AttributeGroup_Constraints() {
    super(MetaIdFactory.conceptId(0xb51b9e0245dc4b48L, 0xb300cf49360a8d1fL, 0x10fe0fc83dbL));
  }
  @Override
  protected Map<SPropertyId, PropertyConstraintsDescriptor> getNotDefaultSProperties() {
    ...
    properties.put(MetaIdFactory.propId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL, 0x10d34fa226eL), new BasePropertyConstraintsDescriptor(MetaIdFactory.propId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL, 0x10d34fa226eL), this) {
      ...
      public Object getValue(SNode node) {
        ...
        return SPropertyOperations.getString(node, MetaAdapterFactory.getProperty(0xb51b9e0245dc4b48L, 0xb300cf49360a8d1fL, 0x10fe0fc83dbL, 0x10fe0ff059aL, "attributeGroupName"));
      }
    });
    return properties;
  }
