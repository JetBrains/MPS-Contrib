...
public class AttributeGroup_Constraints extends BaseConstraintsDescriptor {
  public AttributeGroup_Constraints() {
    super(MetaIdFactory.conceptId(new UUID(-5396545995874219192l, -5548206827574227681l), 1167710782427l));
  }
  @Override
  protected Map<SPropertyId, PropertyConstraintsDescriptor> getNotDefaultSProperties() {
    ...
    properties.put(MetaIdFactory.propId(new UUID(-3554657779850784990l, -7236703803128771572l), 1133920641626l, 1156235010670l), new BasePropertyConstraintsDescriptor(MetaIdFactory.propId(new UUID(-3554657779850784990l, -7236703803128771572l), 1133920641626l, 1156235010670l), this) {
      ...
      public Object getValue(SNode node) {
        ...
        return SPropertyOperations.getString(node, MetaAdapterFactory.getProperty(new UUID(-5396545995874219192l, -5548206827574227681l), 1167710782427l, 1167710946714l, "attributeGroupName"));
      }
    });
    return properties;
  }
