...
public class ElementWithContent_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createProperty_cvtcu2_b0a(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(ElementWithContent_Editor._StyleParameter_QueryFunction_cvtcu2_a1b0a((editorCell == null ? null : editorCell.getContext()), (editorCell == null ? null : editorCell.getSNode()))));
    editorCell.getStyle().putAll(style);
