...
public class check_XMLElementType_references_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode elementType, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if ((SLinkOperations.getTarget(elementType, MetaAdapterFactory.getReferenceLink(new UUID(-6269610502768541194l, -6018622628950326671l), 4815471077468621637l, 4815471077468621639l, "schema")) != null)) {
      ...
      } else if (SNodeOperations.getAncestor(SLinkOperations.getTarget(elementType, MetaAdapterFactory.getReferenceLink(new UUID(-6269610502768541194l, -6018622628950326671l), 4815471077468621637l, 4815471077468621640l, "complexType")), "jetbrains.mps.xmlSchema.structure.Schema", false, false) != SLinkOperations.getTarget(elementType, MetaAdapterFactory.getReferenceLink(new UUID(-6269610502768541194l, -6018622628950326671l), 4815471077468621637l, 4815471077468621639l, "schema"))) {
        {
          MessageTarget errorTarget = new NodeMessageTarget();
