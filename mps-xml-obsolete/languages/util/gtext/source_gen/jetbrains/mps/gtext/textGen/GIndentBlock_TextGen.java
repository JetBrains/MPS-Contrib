...
public class GIndentBlock_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    this.increaseDepth();
    appendNode(SLinkOperations.getTarget(node, MetaAdapterFactory.getContainmentLink(0xa83c3bd02f7e4ba1L, 0x837312d49e99f57eL, 0x10f1ca0f1e6L, 0x10fb24393c9L, "itemList")));
    this.decreaseDepth();
    if (getBuffer().hasPositionsSupport()) {
      {
