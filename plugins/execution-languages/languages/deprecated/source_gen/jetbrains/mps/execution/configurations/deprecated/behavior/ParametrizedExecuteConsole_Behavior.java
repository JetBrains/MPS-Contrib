...
public class ParametrizedExecuteConsole_Behavior {
  ...
  private static SNode _quotation_createNode_n7vuic_a0a0() {
    ...
    quotedNode_2.setReference("classifier", jetbrains.mps.smodel.SReference.create("classifier", quotedNode_2, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#javax.swing(JDK/javax.swing@java_stub)"), SNodeId.fromString("~JComponent")));
