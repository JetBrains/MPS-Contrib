...
public class JavaRunConfiguration_Behavior {
  ...
  private static SNode _quotation_createNode_r2ediq_a0a0a2() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("r:68c7815b-65d3-4b04-9110-50fab74211e0(jetbrains.mps.execution.configurations.deprecated.runtime)"), jetbrains.mps.smodel.SNodeId.fromString("4631964019510578639")));
    return quotedNode_1;
  }
