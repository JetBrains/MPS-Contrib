  ...
  public void applyRule(final SNode statement, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:3d1d89d4-ed40-464f-804b-a59886f41d55(jetbrains.mps.execution.configurations.deprecated.typesystem)", "314981645426569987", true), (SNode) new typeof_ActionListStatement_InferenceRule.QuotationClass_aab8tt_a0a0a0().createNode(typeCheckingContext), false, true, _info_12389875345);
    }
  }
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_2 = null;
      {
        ...
        SNode quotedNode1_3 = quotedNode_1;
        {
          ...
          quotedNode1_4.setReference("classifier", SReference.create("classifier", quotedNode1_4, SModelReference.fromString("f:java_stub#742f6602-5a2f-4313-aa6e-ae1cd4ffdc61#com.intellij.openapi.actionSystem(MPS.Platform/com.intellij.openapi.actionSystem@java_stub)"), SNodeId.fromString("~AnAction")));
