...
public class FixReferencesToDeletedRunModels_MigrationScript extends BaseMigrationScript {
  public FixReferencesToDeletedRunModels_MigrationScript(IOperationContext operationContext) {
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public void doUpdateInstanceNode(SNode node) {
        ScriptsUtil.updateReferencesToModel(node, "jetbrains.mps.baseLanguage.util.plugin.run", SNodeOperations.getModel(SLinkOperations.getTarget(_quotation_createNode_26ji2y_a0a0c0a0a0(), "classifier", false)).getSModelReference());
      }
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public void doUpdateInstanceNode(SNode node) {
        ScriptsUtil.updateReferencesToModel(node, "jetbrains.mps.lang.plugin.run", SNodeOperations.getModel(SLinkOperations.getTarget(_quotation_createNode_26ji2y_a0a0c0a0a1(), "classifier", false)).getSModelReference());
      }
  ...
  private static SNode _quotation_createNode_26ji2y_a0a0c0a0a0() {
    ...
    quotedNode_1.setReference("classifier", jetbrains.mps.smodel.SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#920eaa0e-ecca-46bc-bee7-4e5c59213dd6#jetbrains.mps(Testbench/jetbrains.mps@java_stub)"), SNodeId.fromString("~MPSLaunch")));
    return quotedNode_1;
  }
  ...
  private static SNode _quotation_createNode_26ji2y_a0a0c0a0a1() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", null, null, GlobalScope.getInstance(), false);
    quotedNode_1.setReference("classifier", jetbrains.mps.smodel.SReference.create("classifier", quotedNode_1, SModelReference.fromString("r:82f15792-6966-47aa-8004-b293ab2bcfd2(jetbrains.mps.lang.plugin.run)"), SNodeId.fromString("242278890011773407")));
    return quotedNode_1;
  }
}
