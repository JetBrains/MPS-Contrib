...
public class ParametrizedExecuteProcess_Behavior {
  ...
  private static SNode _quotation_createNode_9hdhrc_a0a0() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#742f6602-5a2f-4313-aa6e-ae1cd4ffdc61#com.intellij.execution.process(MPS.Platform/com.intellij.execution.process@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~ProcessHandler")));
    return quotedNode_1;
  }
}
