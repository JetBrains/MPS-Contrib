...
public class typeof_ExecutionConsoleStatement_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
    ...
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(SLinkOperations.getTarget(statement, "consoleComponent", true), "r:3d1d89d4-ed40-464f-804b-a59886f41d55(jetbrains.mps.execution.configurations.deprecated.typesystem)", "314981645426569914", true), (SNode) _quotation_createNode_vjw2r0_a0a0a(), true, false, _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_vjw2r0_a0a0a() {
