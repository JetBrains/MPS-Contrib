...
public class AttributeDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createProperty_vddsqv_b0(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(AttributeDeclaration_Editor._StyleParameter_QueryFunction_vddsqv_a1b0((editorCell == null ?
      null :
