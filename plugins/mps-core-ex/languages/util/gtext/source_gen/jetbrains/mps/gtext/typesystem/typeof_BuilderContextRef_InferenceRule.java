...
public class typeof_BuilderContextRef_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  private static SNode _quotation_createNode_m3afeb_a0a0b() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("r:1773d365-6692-4940-84a5-a678462b1f6f(jetbrains.mps.gtext.runtime)"), jetbrains.mps.smodel.SNodeId.fromString("7733366827988671037")));
    return quotedNode_1;
  }
}
