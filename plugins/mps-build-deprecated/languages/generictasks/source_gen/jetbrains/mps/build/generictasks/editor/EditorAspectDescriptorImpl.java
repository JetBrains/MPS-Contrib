...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  public Collection<ConceptEditorComponent> getEditorComponents(ConceptDescriptor descriptor, String editorComponentId) {
    switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0d, descriptor.getConceptFqName())) {
      ...
      case 1:
        ...
        break;
      case 2:
        switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0c0a3, editorComponentId)) {
          case 0:
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0c = new String[]{"jetbrains.mps.build.generictasks.structure.Attribute", "jetbrains.mps.build.generictasks.structure.AttributeDeclaration", "jetbrains.mps.build.generictasks.structure.BuiltInTaskDeclaration", "jetbrains.mps.build.generictasks.structure.NestedDeclaration", "jetbrains.mps.build.generictasks.structure.PathReference", "jetbrains.mps.build.generictasks.structure.TaskCall", "jetbrains.mps.build.generictasks.structure.TaskInterfaceDeclaration", "jetbrains.mps.build.generictasks.structure.TaskReference"};
  private static String[] stringSwitchCases_xbvbvu_a0a0b0a3 = new String[]{"jetbrains.mps.build.generictasks.editor.GenericAttributeDeclarationInEnum_EditorComponent", "jetbrains.mps.build.generictasks.editor.GenericAttributeDeclaration_EditorComponent"};
  private static String[] stringSwitchCases_xbvbvu_a0a0c0a3 = new String[]{"jetbrains.mps.build.generictasks.editor.TaskDeclarationAttributes_EditorComponent", "jetbrains.mps.build.generictasks.editor.TaskDeclarationHeader_EditorComponent", "jetbrains.mps.build.generictasks.editor.TaskDeclarationInspector_EditorComponent"};
  private static String[] stringSwitchCases_xbvbvu_a0a0d = new String[]{"jetbrains.mps.build.generictasks.structure.Attribute", "jetbrains.mps.build.generictasks.structure.AttributeDeclaration", "jetbrains.mps.build.generictasks.structure.ITaskDeclaration"};
}
