...
public class PropertyValueExpression_Behavior {
  ...
  public static String callSuperNew_toString_1213877472569(SNode thisNode, String callerConceptFqName) {
    return (String) BehaviorManager.getInstance().invokeSuperNew(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.buildlanguage.structure.PropertyValueExpression"), callerConceptFqName, "virtual_toString_1213877472569", PARAMETERS_1213877472569, new Object[]{});
  }

  public static String callSuperNew_getActualValue_1213877472572(SNode thisNode, String callerConceptFqName) {
    return (String) BehaviorManager.getInstance().invokeSuperNew(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.buildlanguage.structure.PropertyValueExpression"), callerConceptFqName, "virtual_getActualValue_1213877472572", PARAMETERS_1213877472572, new Object[]{});
  }
