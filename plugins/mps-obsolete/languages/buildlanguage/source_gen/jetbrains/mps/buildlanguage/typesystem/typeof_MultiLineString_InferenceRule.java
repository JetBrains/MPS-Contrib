...
public class typeof_MultiLineString_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode string, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895904c4(jetbrains.mps.buildlanguage.typesystem)", "1226433430077", true), (SNode) _quotation_createNode_anewhv_a0a0a(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_anewhv_a0a0a() {
