...
public class PublicId_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_7240_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_7240_0(editorContext, node, "PUBLIC"));
  ...
  private EditorCell createConstant_7240_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_7240_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_7240_2(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_7240_3(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_7240_4(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_7240_5(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
