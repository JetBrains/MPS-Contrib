...
public class EmbeddedGraphModifier_Test extends TestCase {
  ...
  public void test_test2() throws Exception {
    ...
    Graph graph = GraphIO.scanGraph(new Scanner(graphString));
    /*
      Node first = ListSequence.fromList(graph.getNodes()).first();
      Map<Node, List<Node>> nodeMap = MapSequence.fromMap(new HashMap<Node, List<Node>>());
      EmbeddedGraphModifier modifier = prepare(graph, nodeMap);
      modifier.makeRectangleForSplittedNode(MapSequence.fromMap(nodeMap).get(first));
