...
<model name="jetbrains.mps.uiLanguage.samples.componentMethods">
      ...
      <node role="content" type="jetbrains.mps.uiLanguage.structure.AttributeValue" id="1202810659216">
        ...
        <node role="value" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression" id="1217888404062">
          <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator" id="1217888404064">
            <link role="baseMethodDeclaration" targetNodeId="2.~Dimension.&lt;init&gt;(int,int)"
                  resolveInfo="Dimension"/>
  ...
  <node type="jetbrains.mps.uiLanguage.structure.ComponentController" id="1202810679159">
    ...
    <node role="componentMethod"
          type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration" id="1205770172009">
    ...
    <node role="componentMethod"
          type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration" id="1205770171940">
