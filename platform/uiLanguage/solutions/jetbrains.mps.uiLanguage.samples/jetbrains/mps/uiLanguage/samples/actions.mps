...
<model modelUID="r:1222075024729(jetbrains.mps.uiLanguage.samples.actions)">
  ...
  <import index="5" modelUID="r:1222075024717(jetbrains.mps.uiLanguage.components)" version="-1" />
