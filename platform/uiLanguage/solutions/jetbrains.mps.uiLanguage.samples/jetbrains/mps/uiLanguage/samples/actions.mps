...
<model name="jetbrains.mps.uiLanguage.samples.actions">
  ...
  <node type="jetbrains.mps.uiLanguage.structure.ComponentController" id="1202748791358">
    ...
    <node role="componentMethod"
          type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration" id="1212159164807">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.PlusExpression" id="1212423747700">
              ...
              <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.MinusExpression"
                    id="1212423750068">
                <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.IntegerConstant"
                      id="1212423748141">
                  <property name="value" value="23"/>
                </node>
                <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.MulExpression"
                      id="1212423751307">
                  <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.IntegerConstant"
                        id="1212423750399">
                    <property name="value" value="23"/>
