...
public class ComponentDeclaration_Behavior {
  ...
  public static SNode call_getConstructor_1213877495346(SNode thisNode) {
    if (ComponentDeclaration_Behavior.call_getController_1213877495364(thisNode) == null) {
      return null;
    }
    return SLinkOperations.getTarget(ComponentDeclaration_Behavior.call_getController_1213877495364(thisNode), "constructor", true);
  }
