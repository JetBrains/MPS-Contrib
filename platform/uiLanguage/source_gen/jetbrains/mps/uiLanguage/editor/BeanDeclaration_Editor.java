...
public class BeanDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_7986_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new BeanDeclaration_Editor.attributeListHandler_7986_0(node, "attribute", context);
  ...
  private EditorCell createRefNodeList_7986_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new BeanDeclaration_Editor.methodListHandler_7986_0(node, "method", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
  ...
  private EditorCell createRefNodeList_7986_2(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new BeanDeclaration_Editor.constructorListHandler_7986_0(node, "constructor", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
