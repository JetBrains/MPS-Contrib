...
public class InlineEventHandler_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ConstantCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1208110429206");
  }

  private static void setupBasic_EventReferenceCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1208110434255");
  }
  ...
  public static class _Inline12 extends AbstractCellProvider {
    ...
    private static void setupBasic_NameCell(EditorCell editorCell, SNode node, EditorContext context) {
      editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1208110435867");
    }
