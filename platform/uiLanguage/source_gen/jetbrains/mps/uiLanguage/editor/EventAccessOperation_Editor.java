...
public class EventAccessOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_2701_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_2701_0");
    editorCell.addEditorCell(this.createRefCell_2701_0(context, node));
    return editorCell;
  }

  private EditorCell createRefCell_2701_0(EditorContext context, SNode node) {
  ...
  public static class _Inline2701_0 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.createProperty_2701_0(context, node);
    }

    private EditorCell createProperty_2701_0(EditorContext context, SNode node) {
