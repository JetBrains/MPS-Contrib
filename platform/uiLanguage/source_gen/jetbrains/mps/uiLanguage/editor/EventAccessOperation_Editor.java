...
public class EventAccessOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEventReferenceCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    provider.setAuxiliaryCellProvider(new EventAccessOperation_Editor._Inline13());
  ...
  public static class _Inline13 extends AbstractCellProvider {
    ...
    public EditorCell createNameCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
      ...
      EditorCell editorCell = provider.createEditorCell(context);
      EventAccessOperation_Editor._Inline13.setupBasic_NameCell(editorCell, node, context);
      if (editorCell instanceof EditorCell_Label) {
        EventAccessOperation_Editor._Inline13.setupLabel_NameCell((EditorCell_Label) editorCell, node, context);
      }
      editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
      return editorCell;
    }
