...
public class LayoutConstraint_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_RowCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1202739897565");
  }

  private static void setupBasic_ConstantCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1202739898567");
    Stylesheet_StyleSheet.LAYOUT_CONSTRAINT.apply(editorCell);
  }

  private static void setupBasic_ConstantCell1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1202739904209");
  }

  private static void setupBasic_ConstraintCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1202739906524");
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    LayoutConstraint_Editor.setupBasic_RowCell(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell(context, node, "layout constraint"));
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    LayoutConstraint_Editor.setupBasic_ConstantCell(editorCell, node, context);
    LayoutConstraint_Editor.setupLabel_ConstantCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    LayoutConstraint_Editor.setupBasic_ConstantCell1(editorCell, node, context);
    LayoutConstraint_Editor.setupLabel_ConstantCell1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
