...
public class ActionHandler_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConstant_8008_0(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_8008_0(editorCell, node, context);
  ...
  public EditorCell createConstant_8008_1(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_8008_1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }

  public EditorCell createRefNode_8008_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_RefNode_8008_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_8008_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  private static void setupLabel_Constant_8008_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_8008_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_RefNode_8008_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
