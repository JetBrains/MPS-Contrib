...
public class ListElements_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_1097_0(EditorContext context, SNode node) {
  ...
  private EditorCell createConstant_1097_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_1097_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_1097_0(EditorContext context, SNode node) {
