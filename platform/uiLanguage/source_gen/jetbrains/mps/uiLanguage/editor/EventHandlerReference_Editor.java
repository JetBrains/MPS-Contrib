...
public class EventHandlerReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_2337_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_2337_0");
    editorCell.addEditorCell(this.createRefCell_2337_0(context, node));
    return editorCell;
  }

  private EditorCell createRefCell_2337_0(EditorContext context, SNode node) {
  ...
  public static class _Inline2337_0 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.createProperty_2337_0(context, node);
    }

    private EditorCell createProperty_2337_0(EditorContext context, SNode node) {
