...
public class RemoveListenerOperation_Constraints extends ConstraintsDataHolder {
  ...
  public CanBeASomethingMethod<CanBeAParentContext> getCanBeAParentMethod() {
    return new CanBeASomethingMethod<CanBeAParentContext>() {
      private SNodePointer breakingNode = new SNodePointer("r:fa076d39-0453-4fa7-91d1-765a2fb21a0b(jetbrains.mps.uiLanguage.constraints@2_0)", "1213107435980");
