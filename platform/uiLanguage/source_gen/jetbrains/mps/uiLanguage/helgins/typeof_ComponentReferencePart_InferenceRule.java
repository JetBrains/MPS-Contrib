  ...
  public void applyRule(final SNode nodeToCheck) {
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(nodeToCheck, "jetbrains.mps.uiLanguage.helgins", "1202742681504", true), new QuotationClass_().createNode(SLinkOperations.getTarget(SLinkOperations.getTarget(nodeToCheck, "component", false), "componentDeclaration", false)), _nodeToCheck_1029348928467, null, "jetbrains.mps.uiLanguage.helgins", "1202742685648", intentionProvider);
    }
  }
