...
public class typeof_RemoveListenerOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext) {
    ...
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) SLinkOperations.getTarget(methodNode, "returnType", true), (SNode) new typeof_RemoveListenerOperation_InferenceRule.QuotationClass_4xbi0r_a0a4a0().createNode(typeCheckingContext), _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_4xbi0r_a0a4a0 {
    public QuotationClass_4xbi0r_a0a4a0() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_4xbi0r_a0a4a0 = null;
      {
        quotedNode_4xbi0r_a0a4a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.VoidType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_4xbi0r_a0a4a0 = quotedNode_4xbi0r_a0a4a0;
        result = quotedNode1_4xbi0r_a0a4a0;
      }
      return result;
    }
