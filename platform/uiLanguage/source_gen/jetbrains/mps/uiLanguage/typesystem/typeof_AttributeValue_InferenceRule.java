  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createLessThanInequationStrong(typeCheckingContext.typeOf(SLinkOperations.getTarget(nodeToCheck, "value", true), "r:00000000-0000-4000-0000-011c89590550(jetbrains.mps.uiLanguage.helgins)", "1202396534901", true), SLinkOperations.getTarget(SLinkOperations.getTarget(nodeToCheck, "attribute", false), "type", true), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c89590550(jetbrains.mps.uiLanguage.helgins)", "1202396548783", false, 0, intentionProvider);
    }
  }
