  ...
  public void applyRule(final SNode object, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590550(jetbrains.mps.uiLanguage.typesystem)", "1210521559481", true), (SNode)new _Quotations.QuotationClass_7().createNode(typeCheckingContext), _info_12389875345);
    }
  }
