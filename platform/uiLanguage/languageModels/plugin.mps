...
<model name="jetbrains.mps.uiLanguage.plugin">
            ...
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
              ...
              <node role="initializer" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1207331410204">
                <link role="baseMethodDeclaration"
                      targetNodeId="8.~ComponentController.newInstance(jetbrains.mps.smodel.SModel,boolean):jetbrains.mps.uiLanguage.structure.ComponentController"
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1207331423806">
            <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207331424464">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1207331433066">
                <link role="baseMethodDeclaration"
                      targetNodeId="8.~ComponentController.setComponent(jetbrains.mps.uiLanguage.structure.ComponentDeclaration):void"
  ...
  <node type="jetbrains.mps.bootstrap.pluginLanguage.structure.ActionDeclaration" id="1213619378239">
    ...
    <node role="methodDeclaration"
          type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration" id="1213619381196">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213619381198">
        <node role="statement"
          ...
          <node role="commandClosureLiteral"
                type="jetbrains.mps.bootstrap.smodelLanguage.structure.CommandClosureLiteral" id="1213619389443">
