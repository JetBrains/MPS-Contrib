...
<model modelUID="r:00000000-0000-4000-0000-011c89590552(jetbrains.mps.uiLanguage.plugin)">
    ...
    <languageAspect modelUID="r:00000000-0000-4000-0000-011c89590338(jetbrains.mps.baseLanguage.closures.structure)"
                    version="1"/>
    <languageAspect modelUID="r:00000000-0000-4000-0000-011c8959054e(jetbrains.mps.uiLanguage.constraints)"
                    version="26"/>
    <languageAspect
    ...
    <import index="1" modelUID="r:00000000-0000-4000-0000-011c89590553(jetbrains.mps.uiLanguage.structure)"
            version="1"/>
    <import index="3" modelUID="f:java_stub#java.lang(java.lang@java_stub)" version="-1"/>
    <import index="5" modelUID="f:java_stub#jetbrains.mps.smodel(jetbrains.mps.smodel@java_stub)" version="-1"/>
    <import index="6" modelUID="f:java_stub#jetbrains.mps.ide.ui.smodel(jetbrains.mps.ide.ui.smodel@java_stub)"
            version="-1"/>
    <import index="8"
            modelUID="f:java_stub#jetbrains.mps.uiLanguage.structure(jetbrains.mps.uiLanguage.structure@java_stub)"
            version="-1"/>
    <import index="9" modelUID="r:00000000-0000-4000-0000-011c8959054c(jetbrains.mps.uiLanguage.behavior)"
            version="-1"/>
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1207330934919">
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="1207330974732">
                    <node role="condition" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207330979470">
                        <node role="operand" type="jetbrains.mps.lang.plugin.structure.ConceptFunctionParameter_node"
                              id="1207330977594"/>
                        <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_IsInstanceOfOperation"
                              id="1207330980410">
                            <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference"
                                  id="1207330985770">
                                <link role="conceptDeclaration" targetNodeId="1.1202388384249"
                                      resolveInfo="ComponentController"/>
                            </node>
                        </node>
                    </node>
                    <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1207330974734">
                        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement"
                            ...
                            <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                  id="1207331011058">
                                <node role="operand" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression"
                                      id="1207331005072">
                                    <link role="concept" targetNodeId="1.1202388384249"
                                          resolveInfo="ComponentController"/>
                                    <node role="leftExpression"
                                          type="jetbrains.mps.lang.plugin.structure.ConceptFunctionParameter_node"
                                          id="1207331003977"/>
                                </node>
            ...
            <node role="getNodeBlock" type="jetbrains.mps.lang.plugin.structure.GetNodeBlock" id="1207331143836">
                <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1207331143837">
                    <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                          id="1207331233001">
                        <node role="expression" type="jetbrains.mps.lang.plugin.structure.ConceptFunctionParameter_node"
                              id="1207331233002"/>
                    </node>
                </node>
            </node>
                    ...
                    <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                        ...
                        <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                            ...
                            <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_ConceptMethodCall"
                                  id="1207331297482">
                                <link role="baseMethodDeclaration" targetNodeId="9.1213877495364"
                                      resolveInfo="getController"/>
                            </node>
                        </node>
                    </node>
                </node>
                ...
                <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1207331316078">
                    <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
                        ...
                        <node role="localVariableDeclaration"
                              type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1219415611990">
                            <property name="name" value="controller"/>
                            ...
                            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression"
                                  id="1219415617149">
                                <node role="creator" type="jetbrains.mps.lang.smodel.structure.SNodeCreator"
                                      id="1219415617150">
                                    <node role="createdType" type="jetbrains.mps.lang.smodel.structure.SNodeType"
                                          id="1219415617151">
                                        <link role="concept" targetNodeId="1.1202388384249"
                                              resolveInfo="ComponentController"/>
                                    </node>
                    ...
                    <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                        ...
                        <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression"
                              id="1219415629143">
                            <node role="rValue" type="jetbrains.mps.lang.plugin.structure.ConceptFunctionParameter_node"
                                  id="1219415631334"/>
                            <node role="lValue" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                ...
                                <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference"
                                      id="1219415624592">
                                    <link role="variableDeclaration" targetNodeId="1219415611990"
                                          resolveInfo="controller"/>
                                </node>
                                <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess"
                                      id="1219415626252">
                                    <link role="link" targetNodeId="1.1202388401455"/>
                        ...
                        <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                            ...
                            <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                ...
                                <node role="operand"
                                      type="jetbrains.mps.lang.plugin.structure.ConceptFunctionParameter_node"
                                      id="1219415640591"/>
                                <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_GetModelOperation"
                                      id="1219415642563"/>
                            </node>
                            <node role="operation" type="jetbrains.mps.lang.smodel.structure.Model_AddRootOperation"
                                  id="1219415644536">
                                <node role="nodeArgument"
                    ...
                    <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
                          id="1207331574538">
                        <node role="localVariableDeclaration"
                              type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1207331574539">
                            <property name="name" value="virtualPackage"/>
                            <node role="type" type="jetbrains.mps.baseLanguage.structure.StringType"
                                  id="1225193084057"/>
                            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                ...
                                <node role="operation"
                                    ...
                                    <node role="actualArgument"
                                          type="jetbrains.mps.baseLanguage.structure.StaticFieldReference"
                                          id="1207331656701">
                                        <link role="classifier" targetNodeId="6.~SModelTreeNode"
                                              resolveInfo="SModelTreeNode"/>
                                        <link role="variableDeclaration" targetNodeId="6.~SModelTreeNode.PACK"
                                              resolveInfo="PACK"/>
                                    </node>
                                </node>
                            </node>
                    ...
                    <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                        ...
                        <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                              id="1207331674175">
                            <node role="operand" type="jetbrains.mps.lang.smodel.structure.SemanticDowncastExpression"
                                  id="1219415666386">
                                <node role="leftExpression"
                                      type="jetbrains.mps.baseLanguage.structure.LocalVariableReference"
                                      id="1207331673455">
                            ...
                            <node role="operation"
                                ...
                                <node role="actualArgument"
                                      type="jetbrains.mps.baseLanguage.structure.LocalVariableReference"
                                      id="1207331688617">
                                    <link role="variableDeclaration" targetNodeId="1207331574539"
                                          resolveInfo="virtualPackage"/>
                                </node>
                            </node>
                        </node>
                    </node>
    ...
    <node type="jetbrains.mps.lang.plugin.structure.ActionDeclaration" id="1213619378239">
        <property name="name" value="ABC"/>
        <node role="methodDeclaration"
              type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration"
              id="1213619381196">
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213619381198">
                <node role="statement" type="jetbrains.mps.lang.plugin.structure.ExecuteLightweightCommandStatement"
                      id="1213619389442">
                    <node role="commandClosureLiteral" type="jetbrains.mps.lang.plugin.structure.CommandClosureLiteral"
                          id="1213619389443">
        ...
        <node role="executeFunction" type="jetbrains.mps.lang.plugin.structure.ExecuteBlock" id="1213619378240">
