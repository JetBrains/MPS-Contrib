          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1207331393669">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1207331393670">
              ...
              <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1207331393671">
                <link role="classifier" targetNodeId="8.~ComponentController" resolveInfo="ComponentController" />
              </node>
              <node role="initializer" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1207331410204">
                <link role="baseMethodDeclaration" targetNodeId="8.~ComponentController.newInstance(jetbrains.mps.smodel.SModel,boolean):jetbrains.mps.uiLanguage.structure.ComponentController" resolveInfo="newInstance" />
                <link role="classConcept" targetNodeId="8.~ComponentController" resolveInfo="ComponentController" />
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1207331423806">
            <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207331424464">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1207331433066">
                <link role="baseMethodDeclaration" targetNodeId="8.~ComponentController.setComponent(jetbrains.mps.uiLanguage.structure.ComponentDeclaration):void" resolveInfo="setComponent" />
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.CastExpression" id="1216902685866">
                  <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1216902689275">
                    <link role="classifier" targetNodeId="8.~ComponentDeclaration" resolveInfo="ComponentDeclaration" />
                  </node>
                  <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1216902692449">
                    <node role="operand" type="jetbrains.mps.bootstrap.pluginLanguage.structure.ConceptFunctionParameter_node" id="1216902691917" />
                    <node role="operation" type="jetbrains.mps.bootstrap.smodelLanguage.structure.Node_GetAdapterOperation" id="1216902695718" />
                  </node>
                </node>
              </node>
            </node>
