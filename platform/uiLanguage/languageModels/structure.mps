...
<model name="jetbrains.mps.uiLanguage.structure">
  ...
  <refactoringHistory>
    <refactoringContext modelVersion="0">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="constructor" conceptFQName="jetbrains.mps.uiLanguage.structure.ComponentController"
               featureKind="CHILD"/>
          <value featureName="afterConstruction" conceptFQName="jetbrains.mps.uiLanguage.structureComponentController"
                 featureKind="CHILD"/>
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
    <refactoringContext modelVersion="1">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="ComponentConstructor"
               conceptFQName="jetbrains.mps.uiLanguage.structure.ComponentConstructor" featureKind="CONCEPT"/>
          <value featureName="AfterConstructionBlock"
                 conceptFQName="jetbrains.mps.uiLanguage.structure.AfterConstructionBlock" featureKind="CONCEPT"/>
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
  </refactoringHistory>
