...
public class UnaryDateTimeOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_x1gsdj_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_x1gsdj_b0(editorContext, node));
    return editorCell;
  }

  private EditorCell createConceptProperty_x1gsdj_b0(EditorContext editorContext, SNode node) {
