...
public class DurationType_boxing_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  private static SNodePointer SNODE_POINTER_jq3mqm_a0a0a0a0b0c0a0a0a0a0a0c = new SNodePointer("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Long");
  ...
  public IsApplicableStatus isApplicableAndPattern(SNode argument) {
    {
      GeneratedMatchingPattern pattern = new DurationType_boxing_SubtypingRule.Pattern_jq3mqm_a0a0a0a2();
  ...
  public static class Pattern_jq3mqm_a0a0a0a2 extends GeneratedMatchingPattern implements IMatchingPattern {
    ...
    public boolean match(SNode nodeToMatch) {
      {
        SNode nodeToMatch_5372916090360672786;
        nodeToMatch_5372916090360672786 = nodeToMatch;
        if (!("jetbrains.mps.baseLanguage.structure.ClassifierType".equals(nodeToMatch_5372916090360672786.getConceptFqName()))) {
          return false;
        }
        {
          SNodePointer pointer = SNODE_POINTER_jq3mqm_a0a0a0a0b0c0a0a0a0a0a0c;
          if (!(PatternUtil.matchReferentWithNode(pointer, nodeToMatch_5372916090360672786.getReferent("classifier")))) {
            return false;
          }
        }
      }
