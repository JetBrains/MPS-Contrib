...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    ...
    structureAspect = getAspectDescriptorByClassName("jetbrains.mps.xmlUnitTest.structure.StructureAspectDescriptor");
    behaviorAspect = getAspectDescriptorByClassName("jetbrains.mps.xmlUnitTest.behavior.BehaviorAspectDescriptor");
    constraintsAspect = getAspectDescriptorByClassName("jetbrains.mps.xmlUnitTest.constraints.ConstraintsAspectDescriptor");
