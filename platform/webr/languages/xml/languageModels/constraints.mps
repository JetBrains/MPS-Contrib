...
<model name="webr.xml.constraints">
  ...
  <import index="14" modelUID="webr.xml.actions" />
  <node type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptBehavior" id="1177896211352">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1177896317786">
          <node role="expression" type="jetbrains.mps.baseLanguage.OrExpression" id="1177896335831">
            ...
            <node role="leftExpression" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1177896333642">
              <link role="baseMethodDeclaration" extResolveInfo="10.method ([Classifier]SNode).([InstanceMethodDeclaration]isRoot())" />
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1179110905434">
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1179110930094">
          <node role="expression" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1179110933504">
            <link role="baseMethodDeclaration" extResolveInfo="12.static method ([Classifier]String).([StaticMethodDeclaration]valueOf((jetbrains.mps.baseLanguage.types.boolean/jetbrains.mps.baseLanguage.types.boolean)))" />
    ...
    <node role="method" type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptMethodDeclaration" id="1187013392398">
      <property name="name" value="getSubcontents" />
      <property name="isVirtual" value="true" />
      <node role="returnType" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeListType" id="1187013398531">
        <link role="elementConcept" targetNodeId="1.1161371727643" />
      </node>
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1187013392400">
        <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1187013419653">
          <node role="expression" type="jetbrains.mps.baseLanguage.GenericNewExpression" id="1187013423335">
            <node role="creator" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeListCreator" id="1187013427798">
              <node role="createdType" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeListType" id="1187013427799">
                <link role="elementConcept" targetNodeId="1.1161371727643" />
              </node>
            </node>
          </node>
  ...
  <node type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptBehavior" id="1178187486767">
    ...
    <node role="properties" type="jetbrains.mps.bootstrap.constraintsLanguage.NodePropertyConstraint" id="1175114936762">
      ...
      <node role="propertyGetter" type="jetbrains.mps.bootstrap.constraintsLanguage.ConstraintFunction_PropertyGetter" id="1175114944201">
        <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1175114944202">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1189785465290">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1189785465291">
              <property name="name" value="parentContentList" />
              <node role="type" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeType" id="1189785465292">
                <link role="concept" targetNodeId="1.1163629230879" />
              </node>
              <node role="initializer" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1189785473343">
                <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_GetAncestorOperation" id="1189785477628">
                  <node role="parameter" type="jetbrains.mps.bootstrap.smodelLanguage.OperationParm_Concept" id="1189785490694">
                    <link role="concept" targetNodeId="1.1163629230879" />
                  </node>
                </node>
                <node role="leftExpression" type="jetbrains.mps.bootstrap.constraintsLanguage.PropertyGetter_FunctionParm_node" id="1189785473092" />
              </node>
            </node>
          </node>
          <node role="statement" type="jetbrains.mps.baseLanguage.IfStatement" id="1189785500761">
            <node role="ifTrue" type="jetbrains.mps.baseLanguage.StatementList" id="1189785500762">
              <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1189785505083">
                <node role="expression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1189785507555">
                  <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SPropertyAccess" id="1189785510528">
                    <link role="property" targetNodeId="1.1166231449055" />
                  </node>
                  <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1189785506054">
                    <link role="variableDeclaration" targetNodeId="1189785465291" resolveInfo="parentContentList" />
                  </node>
                </node>
              </node>
            </node>
            <node role="condition" type="jetbrains.mps.baseLanguage.NotEqualsExpression" id="1189785503172">
              <node role="rightExpression" type="jetbrains.mps.baseLanguage.NullLiteral" id="1189785504144" />
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1189785501999">
                <link role="variableDeclaration" targetNodeId="1189785465291" resolveInfo="parentContentList" />
              </node>
            </node>
          </node>
    ...
    <node role="method" type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptMethodDeclaration" id="1187014616529">
      <property name="name" value="getSubcontents" />
      <link role="overridenMethod" targetNodeId="1187013392398" resolveInfo="getSubcontents" />
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1187014616531">
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1187014624605">
          <node role="expression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1187014625003">
            <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkListAccess" id="1187014628628">
              <link role="link" targetNodeId="1.1163629255661" />
            </node>
            <node role="leftExpression" type="jetbrains.mps.bootstrap.constraintsLanguage.ThisNodeExpression" id="1187014624606" />
          </node>
        </node>
      </node>
      <node role="returnType" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeListType" id="1190026820547">
        <link role="elementConcept" targetNodeId="1.1161371727643" />
      </node>
    </node>
  </node>
    ...
    <node role="references" type="jetbrains.mps.bootstrap.constraintsLanguage.NodeReferentConstraint" id="1167866911987">
      ...
      <node role="searchScopeFactory" type="jetbrains.mps.bootstrap.constraintsLanguage.ConstraintFunction_ReferentSearchScope_Factory" id="1167866920004">
        <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1167866920005">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1183728395312">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1183728395313">
              <property name="name" value="elementDeclarations" />
              <node role="type" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeListType" id="1183728395314">
                <link role="elementConcept" targetNodeId="9.1167838236835" />
              </node>
              <node role="initializer" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1183728383076">
                <link role="baseMethodDeclaration" targetNodeId="14.1183727811067" />
                <link role="classConcept" targetNodeId="14.1177614157967" />
                <node role="actualArgument" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1183728386160">
                  <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkAccess" id="1183728387852">
                    <link role="link" targetNodeId="1.1167523262932" />
                  </node>
                  <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1183728385547">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.IfStatement" id="1168383746640">
            <node role="condition" type="jetbrains.mps.baseLanguage.ext.collections.lang.SequenceOperationExpression" id="1171448995950">
              ...
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1183728403003">
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1168383759670">
                  <node role="expression" type="jetbrains.mps.baseLanguage.AssignmentExpression" id="1168383759671">
                    ...
                    <node role="rValue" type="jetbrains.mps.baseLanguage.NewExpression" id="1168383759673">
                      ...
                      <node role="actualArgument" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1183728405927">
                        <link role="variableDeclaration" targetNodeId="1183728395313" resolveInfo="elementDeclarations" />
                      </node>
                    </node>
                  </node>
  ...
  <node type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptBehavior" id="1187710054945">
    <link role="concept" targetNodeId="1.1179102053371" />
    <node role="method" type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptMethodDeclaration" id="1187710057081">
      <property name="name" value="getSubcontents" />
      <link role="overridenMethod" targetNodeId="1187013392398" resolveInfo="getSubcontents" />
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1187710057083">
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1187710066436">
          <node role="expression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1187710070935">
            <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkListAccess" id="1187710072954">
              <link role="link" targetNodeId="1.1163629255661" />
            </node>
            <node role="leftExpression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1187710068357">
              <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkAccess" id="1187710070311">
                <link role="link" targetNodeId="1.1179114219774" />
              </node>
              <node role="leftExpression" type="jetbrains.mps.bootstrap.constraintsLanguage.ThisNodeExpression" id="1187710066437" />
            </node>
          </node>
        </node>
      </node>
      <node role="returnType" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeListType" id="1190026820548">
        <link role="elementConcept" targetNodeId="1.1161371727643" />
      </node>
    </node>
    <node role="constructor" type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptConstructorDeclaration" id="1187710054946">
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1187710054947" />
    </node>
  </node>
</model>
