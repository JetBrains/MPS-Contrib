...
public class Choice_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_8501_0(EditorContext context, SNode node) {
  ...
  private EditorCell createConstant_8501_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_8501_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createConstant_8501_2(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_8501_0(EditorContext context, SNode node) {
  ...
  private EditorCell createRefNode_8501_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
