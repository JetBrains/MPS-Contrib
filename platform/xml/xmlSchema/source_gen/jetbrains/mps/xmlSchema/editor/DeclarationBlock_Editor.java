...
public class DeclarationBlock_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_8297_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new DeclarationBlock_Editor.textLineListHandler_8297_0(node, "textLine", context);
  ...
  private EditorCell createRefNodeList_8297_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new DeclarationBlock_Editor.declarationListHandler_8297_0(node, "declaration", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
