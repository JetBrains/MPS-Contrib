...
public class NamespaceDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createProperty_0717_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_Property_0717_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_Property_0717_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  public EditorCell createProperty_0717_2_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_Property_0717_1(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_Property_0717_1((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
  ...
  private static void setupLabel_Property_0717_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  private static void setupLabel_Property_0717_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
