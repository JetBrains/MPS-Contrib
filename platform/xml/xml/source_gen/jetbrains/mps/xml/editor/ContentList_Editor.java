...
public class ContentList_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_8357_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new ContentList_Editor.contentListHandler_8357_0(node, "content", context);
  ...
  private EditorCell createRefNodeList_8357_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new ContentList_Editor.contentListHandler_8357_1(node, "content", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
  ...
  private EditorCell createRefNodeList_8357_2(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new ContentList_Editor.contentListHandler_8357_2(node, "content", context);
  ...
  private EditorCell createRefNodeList_8357_3(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new ContentList_Editor.contentListHandler_8357_3(node, "content", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Horizontal(), false);
