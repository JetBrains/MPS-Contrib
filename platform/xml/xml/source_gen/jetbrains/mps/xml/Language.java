...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    ...
    structureAspect = getAspectDescriptorByClassName("jetbrains.mps.xml.structure.StructureAspectDescriptor");
    behaviorAspect = getAspectDescriptorByClassName("jetbrains.mps.xml.behavior.BehaviorAspectDescriptor");
    constraintsAspect = getAspectDescriptorByClassName("jetbrains.mps.xml.constraints.ConstraintsAspectDescriptor");
