...
<model modelUID="r:00000000-0000-4000-0000-011c8959058c(jetbrains.mps.webr.xml.sandbox)">
  ...
  <node type="jetbrains.mps.xml.internal.structure.XmlFile" id="1221255820526">
    ...
    <node role="document" type="jetbrains.mps.xml.internal.structure.Document" id="1221255820527">
  ...
  <node type="jetbrains.mps.xml.schema.structure.Schema" id="1221255856670">
    <property name="schemaName" value="sandbox" />
    <node role="declarationBlock" type="jetbrains.mps.xml.schema.structure.DeclarationBlock" id="1221255856671">
      <node role="textLine" type="jetbrains.mps.xml.schema.structure.TextLine" id="1221255856672" />
      <node role="declaration" type="jetbrains.mps.xml.schema.structure.ElementWithContent" id="1221255876206">
        <property name="elementName" value="root" />
        <node role="complexType" type="jetbrains.mps.xml.schema.structure.ComplexType" id="1221255876207">
          <node role="typeExpressionList" type="jetbrains.mps.xml.schema.structure.TypeExpressionList" id="1221255876208" />
        </node>
      </node>
    </node>
    <node role="rootElementReference" type="jetbrains.mps.xml.schema.structure.ElementReference" id="1221255885569">
      <link role="elementDeclaration" targetNodeId="1221255876206" resolveInfo="root" />
    </node>
  </node>
</model>
