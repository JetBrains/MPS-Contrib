...
<model modelUID="r:6ee9ddf7-b590-42c6-a3ec-d4130f464987(jetbrains.mps.build.generictasks.actions)">
  ...
  <node type="jetbrains.mps.lang.actions.structure.NodeSubstituteActions" id="8167803625326066997">
    <property name="name" value="SubstituteAbstractMethodCall" />
    <node role="actionsBuilder" type="jetbrains.mps.lang.actions.structure.NodeSubstituteActionsBuilder" id="8167803625326066998">
      <link role="applicableConcept" targetNodeId="3v.1197027803184" resolveInfo="IOperation" />
      <node role="part" type="jetbrains.mps.lang.actions.structure.AddMenuPart" id="8167803625326067099">
        ...
        <node role="part" type="jetbrains.mps.lang.actions.structure.ParameterizedSubstituteMenuPart" id="8167803625326067101">
          ...
          <node role="query" type="jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_Query" id="8167803625326067103">
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="8167803625326067104">
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="8167803625326069742">
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326069766">
                  <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326069747">
                    <node role="operand" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression" id="8167803625326069743">
                      <node role="creator" type="jetbrains.mps.lang.smodel.structure.SNodeCreator" id="8167803625326069745">
                        <node role="createdType" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="8167803625326069746">
                          <link role="concept" targetNodeId="1.4204020193045984321" resolveInfo="AttributeMethodCall" />
                        </node>
                      </node>
                    </node>
                    <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_ConceptMethodCall" id="8167803625326069751">
                      <link role="baseMethodDeclaration" targetNodeId="4v.8167803625326067118" resolveInfo="getMethods" />
                      <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326069755">
                        <node role="operand" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression" id="8167803625326069753">
                          <link role="concept" targetNodeId="3v.1197027756228" resolveInfo="DotExpression" />
                          <node role="leftExpression" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parentNode" id="8167803625326069752" />
                        </node>
                        <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="8167803625326069759">
                          <link role="link" targetNodeId="3v.1197027771414" />
                        </node>
                      </node>
                      <node role="actualArgument" type="jetbrains.mps.lang.sharedConcepts.structure.ConceptFunctionParameter_model" id="8167803625326069763" />
                      <node role="actualArgument" type="jetbrains.mps.lang.sharedConcepts.structure.ConceptFunctionParameter_scope" id="8167803625326069765" />
                    </node>
                  </node>
                  <node role="operation" type="jetbrains.mps.baseLanguage.collections.structure.ToListOperation" id="8167803625326069770" />
                </node>
              </node>
            </node>
          </node>
          <node role="handler" type="jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_Handler" id="8167803625326067105">
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="8167803625326067106">
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="8167803625326069805">
                <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="8167803625326069806">
                  <property name="name" value="call" />
                  <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="8167803625326069807">
                    <link role="concept" targetNodeId="1.4204020193045984321" resolveInfo="AttributeMethodCall" />
                  </node>
                  <node role="initializer" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression" id="8167803625326069809">
                    <node role="creator" type="jetbrains.mps.lang.smodel.structure.SNodeCreator" id="8167803625326069811">
                      <node role="createdType" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="8167803625326069812">
                        <link role="concept" targetNodeId="1.4204020193045984321" resolveInfo="AttributeMethodCall" />
                      </node>
                    </node>
                  </node>
              ...
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="8167803625326069814">
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326069821">
                  <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326069816">
                    <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="8167803625326069815">
                      <link role="variableDeclaration" targetNodeId="8167803625326069806" resolveInfo="call" />
                    </node>
                    <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="8167803625326069820">
                      <link role="link" targetNodeId="1.2631460705265414465" />
                    </node>
                  </node>
                  <node role="operation" type="jetbrains.mps.lang.smodel.structure.Link_SetTargetOperation" id="8167803625326070820">
                    <node role="linkTarget" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parameterObject" id="8167803625326070823" />
                  </node>
                </node>
              </node>
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="8167803625326070827">
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="8167803625326070830">
                  <link role="variableDeclaration" targetNodeId="8167803625326069806" resolveInfo="call" />
                </node>
              </node>
            </node>
      ...
      <node role="precondition" type="jetbrains.mps.lang.actions.structure.NodeSubstitutePreconditionFunction" id="8167803625326066999">
        <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="8167803625326067000">
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="8167803625326067058">
            <node role="expression" type="jetbrains.mps.baseLanguage.structure.AndExpression" id="8167803625326067067">
              <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326067073">
                <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326112575">
                  <node role="operand" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression" id="8167803625326067071">
                    <link role="concept" targetNodeId="3v.1197027756228" resolveInfo="DotExpression" />
                    <node role="leftExpression" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parentNode" id="8167803625326067070" />
                  </node>
                  <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="8167803625326113761">
                    <link role="link" targetNodeId="3v.1197027771414" />
                  </node>
                </node>
                <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_IsInstanceOfOperation" id="8167803625326067077">
                  <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference" id="8167803625326067079">
                    <link role="conceptDeclaration" targetNodeId="1.1445805690440174700" resolveInfo="AttributeReference" />
                  </node>
                </node>
              </node>
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326067060">
                <node role="operand" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parentNode" id="8167803625326067059" />
                <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_IsInstanceOfOperation" id="8167803625326067064">
                  <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference" id="8167803625326067066">
    ...
    <node role="actionsBuilder" type="jetbrains.mps.lang.actions.structure.NodeSubstituteActionsBuilder" id="8167803625326067081">
      <link role="applicableConcept" targetNodeId="3v.1197027803184" resolveInfo="IOperation" />
      <node role="precondition" type="jetbrains.mps.lang.actions.structure.NodeSubstitutePreconditionFunction" id="8167803625326067082">
        <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="8167803625326067083">
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="8167803625326067084">
            <node role="expression" type="jetbrains.mps.baseLanguage.structure.AndExpression" id="8167803625326067085">
              <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326067086">
                <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326113762">
                  <node role="operand" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression" id="8167803625326067087">
                    <link role="concept" targetNodeId="3v.1197027756228" resolveInfo="DotExpression" />
                ...
                <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_IsInstanceOfOperation" id="8167803625326067089">
                  <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference" id="8167803625326067096">
                    <link role="conceptDeclaration" targetNodeId="1.3874956854920828284" resolveInfo="CustomNestedReference" />
                  </node>
                </node>
              </node>
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326067091">
                <node role="operand" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parentNode" id="8167803625326067092" />
                <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_IsInstanceOfOperation" id="8167803625326067093">
                  <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference" id="8167803625326067094">
                    <link role="conceptDeclaration" targetNodeId="3v.1197027756228" resolveInfo="DotExpression" />
                  </node>
                </node>
              </node>
        ...
        <node role="part" type="jetbrains.mps.lang.actions.structure.ParameterizedSubstituteMenuPart" id="8167803625326069776">
          ...
          <node role="query" type="jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_Query" id="8167803625326069778">
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="8167803625326069779">
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="8167803625326069783">
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326069784">
                  <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326069785">
                    ...
                    <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_ConceptMethodCall" id="8167803625326069789">
                      <link role="baseMethodDeclaration" targetNodeId="4v.8167803625326067118" resolveInfo="getMethods" />
                      <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326069790">
                        <node role="operand" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression" id="8167803625326069791">
                          <link role="concept" targetNodeId="3v.1197027756228" resolveInfo="DotExpression" />
                          <node role="leftExpression" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parentNode" id="8167803625326069792" />
                        </node>
                        <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="8167803625326069793">
                          <link role="link" targetNodeId="3v.1197027771414" />
                        </node>
                      </node>
                      <node role="actualArgument" type="jetbrains.mps.lang.sharedConcepts.structure.ConceptFunctionParameter_model" id="8167803625326069794" />
                      <node role="actualArgument" type="jetbrains.mps.lang.sharedConcepts.structure.ConceptFunctionParameter_scope" id="8167803625326069795" />
                    </node>
                  </node>
                  <node role="operation" type="jetbrains.mps.baseLanguage.collections.structure.ToListOperation" id="8167803625326069796" />
                </node>
              </node>
            </node>
          </node>
          <node role="handler" type="jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_Handler" id="8167803625326069780">
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="8167803625326069781">
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="8167803625326070835">
              ...
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="8167803625326070841">
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326070842">
                  <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="8167803625326070843">
                  ...
                  <node role="operation" type="jetbrains.mps.lang.smodel.structure.Link_SetTargetOperation" id="8167803625326070846">
                    <node role="linkTarget" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parameterObject" id="8167803625326070847" />
                  </node>
                </node>
              </node>
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="8167803625326070848">
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="8167803625326070849">
                  <link role="variableDeclaration" targetNodeId="8167803625326070836" resolveInfo="call" />
                </node>
              </node>
            </node>
