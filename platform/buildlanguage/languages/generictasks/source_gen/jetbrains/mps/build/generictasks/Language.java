...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    ...
    structureAspect = getAspectDescriptorByClassName("jetbrains.mps.build.generictasks.structure.StructureAspectDescriptor");
    behaviorAspect = getAspectDescriptorByClassName("jetbrains.mps.build.generictasks.behavior.BehaviorAspectDescriptor");
    constraintsAspect = getAspectDescriptorByClassName("jetbrains.mps.build.generictasks.constraints.ConstraintsAspectDescriptor");
