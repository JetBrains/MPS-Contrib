...
public class PropertyNode_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_7739_0(editorContext, node);
  }

  private EditorCell createCollection_7739_0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createCollection_7739_1(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_7739_0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_7739_0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_7739_0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new PropertyNode_Editor.declarationListHandler_7739_0(node, "declaration", editorContext);
  ...
  private EditorCell createConceptProperty_7739_0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createProperty_7739_0(EditorContext editorContext, SNode node) {
