...
public class BooleanLiteral_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ValueCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1196866059049");
  ...
  public EditorCell createValueCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    BooleanLiteral_Editor.setupBasic_ValueCell(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      BooleanLiteral_Editor.setupLabel_ValueCell((EditorCell_Label)editorCell, node, context);
    }
