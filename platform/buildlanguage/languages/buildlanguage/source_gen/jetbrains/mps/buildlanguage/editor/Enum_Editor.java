...
public class Enum_Editor extends DefaultNodeEditor {
  ...
  public static class _RefNodeListHandler14 extends RefNodeListHandler {
    ...
    public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
      Enum_Editor._RefNodeListHandler14.setupBasic_ConstantCell1(editorCell, node, context);
      Enum_Editor._RefNodeListHandler14.setupLabel_ConstantCell1(editorCell, node, context);
      editorCell.setDefaultText("");
      return editorCell;
    }
