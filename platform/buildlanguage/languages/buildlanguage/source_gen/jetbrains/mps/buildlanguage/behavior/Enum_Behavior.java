...
public class Enum_Behavior {
  ...
  public static String call_toString_1213877413898(SNode thisNode) {
    ...
    sb.append("{");
    for(int i = 0 ; i < ListSequence.fromList(SLinkOperations.getTargets(thisNode, "constants", true)).count() ; i = i + 1) {
  ...
  public static boolean call_inEnum_1213877413964(SNode thisNode, SNode nodeToCheck) {
    for(SNode constant : SLinkOperations.getTargets(thisNode, "constants", true)) {
