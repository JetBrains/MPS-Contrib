...
public class PropertyDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_5641_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_5641_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_5641_2(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
