...
public class ImportPropertyNode_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRefCell_8432_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
  ...
  public EditorCell createConceptProperty_8432_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
    EditorCell editorCell = provider.createEditorCell(context);
  ...
  public static class _Inline8432_0 extends AbstractCellProvider {
    ...
    public EditorCell createProperty_8432_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
      EditorCell editorCell = provider.createEditorCell(context);
