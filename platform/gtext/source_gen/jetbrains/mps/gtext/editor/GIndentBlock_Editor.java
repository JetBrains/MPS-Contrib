...
public class GIndentBlock_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRefNode_9362_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_RefNode_9362_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_9362_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }

  public EditorCell createRefNode_9362_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
    provider.setRole("itemList");
    provider.setNoTargetText("<no itemList>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.createRefNode_9362_0_internal(context, node, provider);
  ...
  private static void setupBasic_Collection_9362_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_9362_0");
  }

  private static void setupBasic_Constant_9362_0(EditorCell editorCell, SNode node, EditorContext context) {
