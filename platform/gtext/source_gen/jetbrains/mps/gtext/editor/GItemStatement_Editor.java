...
public class GItemStatement_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_8009_0(editorContext, node);
  }
  ...
  private EditorCell createRefNodeList_8009_0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new GItemStatement_Editor.itemListHandler_8009_0(node, "item", editorContext);
