...
<model modelUID="r:00000000-0000-4000-0000-011c89590574(jetbrains.mps.gtext.plugin)">
    ...
    <import index="3"
            modelUID="f:java_stub#jetbrains.mps.generator.fileGenerator(jetbrains.mps.generator.fileGenerator@java_stub)"
            version="-1"/>
    ...
    <import index="9" modelUID="f:java_stub#jetbrains.mps.gtext.structure(jetbrains.mps.gtext.structure@java_stub)"
            version="-1"/>
    <node type="jetbrains.mps.lang.plugin.structure.FileGeneratorPluginDeclaration" id="1217339451549">
        <node role="getFileGeneratorBlock" type="jetbrains.mps.lang.plugin.structure.GetFileGeneratorBlock"
              id="1217339451550">
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression"
                        ...
                        <node role="creator" type="jetbrains.mps.baseLanguage.structure.AnonymousClassCreator"
                            ...
                            <node role="cls" type="jetbrains.mps.baseLanguage.structure.AnonymousClass"
                                  id="1217339722595">
                                <link role="classifier" targetNodeId="3.~DefaultFileGenerator"
                                      resolveInfo="DefaultFileGenerator"/>
                                ...
                                <node role="method"
                                    ...
                                    <node role="visibility" type="jetbrains.mps.baseLanguage.structure.PublicVisibility"
                                          id="1217339722598"/>
                                    <node role="returnType" type="jetbrains.mps.baseLanguage.structure.BooleanType"
                                          id="1217339722599"/>
                                    <node role="parameter"
                                          type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration"
                                          id="1217339722600">
                                        <property name="name" value="n"/>
                                        <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType"
                                              id="1217339722601">
                                            <link role="classifier" targetNodeId="5.~INodeAdapter"
                                                  resolveInfo="INodeAdapter"/>
                                        </node>
                                    </node>
                                    <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList"
                                          id="1217339722602">
                                        <node role="statement"
                                              type="jetbrains.mps.baseLanguage.structure.ReturnStatement"
                                              id="1217339726500">
                                            <node role="expression"
                                                  type="jetbrains.mps.baseLanguage.structure.InstanceOfExpression"
                                                  id="1217339733878">
                                                <node role="classType"
                                                      type="jetbrains.mps.baseLanguage.structure.ClassifierType"
                                                      id="1223380073948">
                                                    <link role="classifier" targetNodeId="9.~GDocument"
                                                          resolveInfo="GDocument"/>
                                                </node>
                                                <node role="leftExpression"
                                                      type="jetbrains.mps.baseLanguage.structure.ParameterReference"
                                                      id="1217339731736">
                                                    <link role="variableDeclaration" targetNodeId="1217339722600"
                                                          resolveInfo="n"/>
                                                </node>
                                            </node>
                                        </node>
                                        ...
                                        <node role="statement"
                                            ...
                                            <node role="localVariableDeclaration"
                                                ...
                                                <node role="initializer"
                                                      type="jetbrains.mps.baseLanguage.structure.CastExpression"
                                                      id="1217339755943">
                                                    <node role="type"
                                                          type="jetbrains.mps.baseLanguage.structure.ClassifierType"
                                                          id="1217339755944">
                                                    ...
                                                    <node role="expression"
                                                          type="jetbrains.mps.baseLanguage.structure.ParameterReference"
                                                          id="1217339763775">
                                                        <link role="variableDeclaration" targetNodeId="1217339722606"
                                                              resolveInfo="n"/>
                                                    </node>
                                                </node>
                                            </node>
                                        ...
                                        <node role="statement"
                                            ...
                                            <node role="expression"
                                                ...
                                                <node role="operand"
                                                      ...
                                                      id="1217339767060">
                                                    <link role="variableDeclaration" targetNodeId="1217339751768"
                                                          resolveInfo="gd"/>
                                                </node>
                                                <node role="operation"
                                                    ...
                                                    <link role="baseMethodDeclaration"
                                                          targetNodeId="9.~GDocument.getExtension():java.lang.String"
                                                          resolveInfo="getExtension"/>
                                                </node>
                                            </node>
                                        </node>
                                    </node>
