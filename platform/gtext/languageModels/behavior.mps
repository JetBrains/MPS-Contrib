...
<model modelUID="r:00000000-0000-4000-0000-011c89590570(jetbrains.mps.gtext.behavior)">
  ...
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877183413">
    <link role="concept" targetNodeId="1.1211920502338" resolveInfo="GContentBlock" />
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877183414">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877183415" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877245919">
    <link role="concept" targetNodeId="1.1164412982980" resolveInfo="GItemList" />
    <node role="method" type="jetbrains.mps.lang.constraints.structure.ConceptMethodDeclaration" id="1213877245920">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877245921">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.ext.collections.lang.structure.ForEachStatement" id="1213877245926">
          ...
          <node role="inputSequence" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877245928">
            <node role="operand" type="jetbrains.mps.lang.constraints.structure.ThisNodeExpression" id="1213877245929" />
    ...
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877245950">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877245951" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877254059">
    <link role="concept" targetNodeId="1.1181754781153" resolveInfo="BuilderContextRef" />
    <node role="method" type="jetbrains.mps.lang.constraints.structure.ConceptMethodDeclaration" id="1213877254060">
    ...
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877254067">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877254068" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877257058">
    <link role="concept" targetNodeId="1.1166926309597" resolveInfo="GLine" />
    <node role="method" type="jetbrains.mps.lang.constraints.structure.ConceptMethodDeclaration" id="1213877257059">
      <property name="name" value="isComplex" />
      <property name="isPrivate" value="false" />
      <link role="overriddenMethod" targetNodeId="1213877298853" resolveInfo="isComplex" />
    ...
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877257064">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877257065" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877296938">
    <link role="concept" targetNodeId="1.1184639540818" resolveInfo="GDocument" />
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877296939">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877296940" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877298852">
    <link role="concept" targetNodeId="1.1164412935041" resolveInfo="GItem" />
    <node role="method" type="jetbrains.mps.lang.constraints.structure.ConceptMethodDeclaration" id="1213877298853">
      <property name="name" value="isComplex" />
    ...
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877298858">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877298859" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877310934">
    <link role="concept" targetNodeId="1.1186170508337" resolveInfo="GTextConcept" />
    <node role="method" type="jetbrains.mps.lang.constraints.structure.ConceptMethodDeclaration" id="1213877310935">
          ...
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.NotExpression" id="1213877310939">
            <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877310940">
              <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877310941">
                <node role="operand" type="jetbrains.mps.lang.constraints.structure.ThisNodeExpression" id="1213877310942" />
    ...
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877310946">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877310947" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877314286">
    <link role="concept" targetNodeId="1.1164412789837" resolveInfo="GText" />
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877314287">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877314288" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877432356">
    <link role="concept" targetNodeId="1.1211920428461" resolveInfo="GContentPlaceholder" />
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877432357">
