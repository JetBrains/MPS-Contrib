...
public class DateTimePlusPeriodOperation_leftOperand_actionMap {
  ...
  public static class DateTimePlusPeriodOperation_leftOperand_actionMap_DELETE extends AbstractCellAction {
    ...
    public void execute_internal(EditorContext editorContext, SNode node) {
      SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, MetaAdapterFactory.getContainmentLink(new UUID(-3689458971415590814l, -6289781637635314138l), 1207143297026l, 1207143609181l, "rightValue")));
    }
  }
