...
public class PeriodSeparatorFormatToken_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_ih8plz_a0(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.PUNCTUATION_LEFT, 0, PeriodSeparatorFormatToken_Editor._StyleParameter_QueryFunction_ih8plz_a0a0((editorCell == null ? null : editorCell.getContext()), (editorCell == null ? null : editorCell.getSNode())));
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private static boolean _StyleParameter_QueryFunction_ih8plz_a0a0(EditorContext editorContext, SNode node) {
    return !(SPropertyOperations.hasValue(node, MetaAdapterFactory.getProperty(0xcccc689cf3654862L, 0xa8b634ecddf8ee26L, 0x4d760db7e8735b72L, 0x4d760db7e8735b7bL, "kind"), "ifAfter", "default"));
  }
  ...
  private static boolean renderingCondition_ih8plz_a2a(SNode node, EditorContext editorContext) {
    return isNotEmptyString(SPropertyOperations.getString(node, MetaAdapterFactory.getProperty(0xcccc689cf3654862L, 0xa8b634ecddf8ee26L, 0x4d760db7e8735b72L, 0x4d760db7e8735b74L, "lastText"))) && SPropertyOperations.hasValue(node, MetaAdapterFactory.getProperty(0xcccc689cf3654862L, 0xa8b634ecddf8ee26L, 0x4d760db7e8735b72L, 0x4d760db7e8735b7bL, "kind"), "default", "default");
  }
  ...
  private EditorCell createConstant_ih8plz_d0(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.PUNCTUATION_RIGHT, 0, PeriodSeparatorFormatToken_Editor._StyleParameter_QueryFunction_ih8plz_a0d0((editorCell == null ? null : editorCell.getContext()), (editorCell == null ? null : editorCell.getSNode())));
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private static boolean _StyleParameter_QueryFunction_ih8plz_a0d0(EditorContext editorContext, SNode node) {
    return !(SPropertyOperations.hasValue(node, MetaAdapterFactory.getProperty(0xcccc689cf3654862L, 0xa8b634ecddf8ee26L, 0x4d760db7e8735b72L, 0x4d760db7e8735b7bL, "kind"), "ifBefore", "default"));
  }
  ...
  private static boolean renderingCondition_ih8plz_a1a(SNode node, EditorContext editorContext) {
    return SPropertyOperations.hasValue(node, MetaAdapterFactory.getProperty(0xcccc689cf3654862L, 0xa8b634ecddf8ee26L, 0x4d760db7e8735b72L, 0x4d760db7e8735b7bL, "kind"), "default", "default");
  }
