...
public class RunConfigParameterReferenceOperation_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_utb8p6_a(editorContext, node);
  }
  ...
  private EditorCell createRefCell_utb8p6_a0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_utb8p6_a0a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_utb8p6_a0a0(editorContext, node);
    }

    private EditorCell createProperty_utb8p6_a0a0(EditorContext editorContext, SNode node) {
