...
public class IRunConfigPropertyInstance_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_etnx7z_a(editorContext, node);
  }
  ...
  private EditorCell createProperty_etnx7z_a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_etnx7z_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "=");
    editorCell.setCellId("Constant_etnx7z_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createRefNode_etnx7z_c0(EditorContext editorContext, SNode node) {
