...
public class JavaCheckBlock_Constraints extends BaseConstraintsDescriptor {
  public JavaCheckBlock_Constraints() {
    super(MetaIdFactory.conceptId(new UUID(-9024322794181865535l, -5381379368254122047l), 8456022385895584871l));
  }
  @Override
  ...
  public static boolean static_canBeAChild(SNode node, SNode parentNode, SNode link, SNode childConcept, final IOperationContext operationContext) {
    return (SNodeOperations.getNodeAncestor(parentNode, MetaAdapterFactory.getConcept(new UUID(-9024322794181865535l, -5381379368254122047l), 8456022385895583119l, "jetbrains.mps.execution.configurations.deprecated.structure.JavaNodeRunConfiguration"), true, false) != null);
  }
