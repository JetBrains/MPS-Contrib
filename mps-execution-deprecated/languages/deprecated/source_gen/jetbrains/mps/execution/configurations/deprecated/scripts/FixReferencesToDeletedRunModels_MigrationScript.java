...
public class FixReferencesToDeletedRunModels_MigrationScript extends BaseMigrationScript {
  public FixReferencesToDeletedRunModels_MigrationScript(IOperationContext operationContext) {
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public void doUpdateInstanceNode(SNode node) {
        ScriptsUtil.updateReferencesToModel(node, "jetbrains.mps.baseLanguage.util.plugin.run", SNodeOperations.getModel(SLinkOperations.getTarget(_quotation_createNode_26ji2y_a0a0c0a0a0(), MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"))).getReference());
      }
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public void doUpdateInstanceNode(SNode node) {
        ScriptsUtil.updateReferencesToModel(node, "jetbrains.mps.lang.plugin.run", SNodeOperations.getModel(SLinkOperations.getTarget(_quotation_createNode_26ji2y_a0a0c0a0a1(), MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"))).getReference());
      }
      public boolean isShowAsIntention() {
        return false;
      }
  ...
  private static SNode _quotation_createNode_26ji2y_a0a0c0a0a1() {
    ...
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", null, null, false);
    quotedNode_1.setReference(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), SReference.create(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), quotedNode_1, facade.createModelReference("r:09ae1f9b-32e9-4f71-85df-1271dde1eb7a(jetbrains.mps.lang.plugin.run)"), facade.createNodeId("8321286824330329604")));
    return quotedNode_1;
  }
}
