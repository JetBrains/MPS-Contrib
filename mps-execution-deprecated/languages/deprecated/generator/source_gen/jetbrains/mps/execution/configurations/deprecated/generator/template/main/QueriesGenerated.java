...
public class QueriesGenerated {
      ...
      if ((SLinkOperations.getTarget(config, "isApplicableBlock", true) != null)) {
        for (SNode statement : ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(SLinkOperations.getTarget(config, "isApplicableBlock", true), "body", true), "statement", true))) {
          if (LastStatementUtil.canMakeReturnStatement(statement)) {
            SNodeOperations.replaceWithAnother(statement, _quotation_createNode_x583g4_a0a0a0a0a0a0a38(SLinkOperations.getTarget(SNodeOperations.cast(statement, "jetbrains.mps.baseLanguage.structure.ExpressionStatement"), "expression", true)));
          }
        }
      }
    }
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0a0a0a0a38(Object parameter_1) {
