...
public class EventDeclaration_Behavior {
  ...
  public static List<SNode> virtual_getOperationConcept_3044950653914717125(SAbstractConcept thisConcept) {
    ...
    ListSequence.fromList(result).addElement(SNodeOperations.getNode("r:00000000-0000-4000-0000-011c89590553(jetbrains.mps.uiLanguage.structure)", "1208089639160"));
    return result;
  }
}
