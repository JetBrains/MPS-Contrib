...
public class RunConfigParameterReferenceOperation_Constraints extends BaseConstraintsDescriptor {
  ...
  public RunConfigParameterReferenceOperation_Constraints() {
    super("jetbrains.mps.execution.configurations.deprecated.structure.RunConfigParameterReferenceOperation");
  }
  ...
  public static boolean static_canBeAChild(final IOperationContext operationContext, final CanBeAChildContext _context) {
    return (SNodeOperations.getAncestor(_context.getParentNode(), "jetbrains.mps.execution.configurations.deprecated.structure.IExecuteConfigBlock", false, false) != null);
  }
}
