...
public class IsApplicableBlock_Behavior {
  ...
  public static SNode virtual_getExpectedReturnType_1213877374441(SNode thisNode) {
    return new IsApplicableBlock_Behavior.QuotationClass_alktie_a0a0b().createNode();
  }

  public static class QuotationClass_alktie_a0a0b {
    public QuotationClass_alktie_a0a0b() {
    }
