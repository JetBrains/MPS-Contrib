...
public class JavaNodeRunConfiguration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_oxce8e_b1a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_oxce8e_b1b0(editorContext, node));
    editorCell.addEditorCell(this.createComponent_oxce8e_c1b0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createComponent_oxce8e_c1b0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_oxce8e_b1b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
    editorCell.setCellId("Constant_oxce8e_b1b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
