...
public class FormatTokenSettings_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_0889_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new FormatTokenSettings_Editor.predefinedDateFormatListHandler_0889_0(node, "predefinedDateFormat", context);
  ...
  private EditorCell createRefNodeList_0889_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new FormatTokenSettings_Editor.dateTimePropertyCardinalityListHandler_0889_0(node, "dateTimePropertyCardinality", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_0889_2(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new FormatTokenSettings_Editor.dateTimePropertyFormatConfigurationListHandler_0889_0(node, "dateTimePropertyFormatConfiguration", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
