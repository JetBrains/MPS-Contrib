...
public class typeof_TimeZoneConstant_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode constant, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1238513936802", true), (SNode) new typeof_TimeZoneConstant_InferenceRule.QuotationClass_i36dr4_a0a0a0().createNode(typeCheckingContext), _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_i36dr4_a0a0a0 {
    public QuotationClass_i36dr4_a0a0a0() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_i36dr4_a0a0a0 = null;
      {
        quotedNode_i36dr4_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.DateTimeZoneType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_i36dr4_a0a0a0 = quotedNode_i36dr4_a0a0a0;
        result = quotedNode1_i36dr4_a0a0a0;
      }
      return result;
    }
