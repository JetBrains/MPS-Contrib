...
public class PeriodInPropertyOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConstant_3248_0(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_3248_0(editorCell, node, context);
  ...
  public EditorCell createConstant_3248_1(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_3248_1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createRefCell_3248_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefCell_3248_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  public EditorCell createProperty_3248_2_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_Property_3248_1((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
  ...
  public EditorCell createRefNode_3248_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_3248_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
  ...
  private static void setupLabel_Constant_3248_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_RefCell_3248_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_3248_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Property_3248_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_RefNode_3248_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public static class _Inline3248_0 extends AbstractCellProvider {
    ...
    public EditorCell createProperty_3248_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
      ...
      if (editorCell instanceof EditorCell_Label) {
        setupLabel_Property_3248_0((EditorCell_Label)editorCell, node, context);
      }
      editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
      return editorCell;
    }
    ...
    private static void setupLabel_Property_3248_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
    }
