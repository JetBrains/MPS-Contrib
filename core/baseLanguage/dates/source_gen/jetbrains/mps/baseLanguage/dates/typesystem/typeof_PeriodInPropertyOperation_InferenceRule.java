...
public class typeof_PeriodInPropertyOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1239808414992", true), (SNode) new typeof_PeriodInPropertyOperation_InferenceRule.QuotationClass_1332_0().createNode(typeCheckingContext), _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createLessThanInequation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1548440323223477057", true), (SNode) new typeof_PeriodInPropertyOperation_InferenceRule.QuotationClass_1332_1().createNode(typeCheckingContext), false, _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_1332_0 {
    public QuotationClass_1332_0() {
    }
  ...
  public static class QuotationClass_1332_1 {
    public QuotationClass_1332_1() {
    }
