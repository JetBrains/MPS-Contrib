...
public class typeof_DateTimePlusPeriodOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_k52wcs_a0a0a0 {
    public QuotationClass_k52wcs_a0a0a0() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_k52wcs_a0a0a0 = null;
      {
        quotedNode_k52wcs_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.DateTimeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_k52wcs_a0a0a0 = quotedNode_k52wcs_a0a0a0;
        result = quotedNode1_k52wcs_a0a0a0;
      }
      return result;
    }
  ...
  public static class QuotationClass_k52wcs_a0a1a0 {
    public QuotationClass_k52wcs_a0a1a0() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_k52wcs_a0a1a0 = null;
      {
        quotedNode_k52wcs_a0a1a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.DateTimeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_k52wcs_a0a1a0 = quotedNode_k52wcs_a0a1a0;
        result = quotedNode1_k52wcs_a0a1a0;
      }
      return result;
    }
  ...
  public static class QuotationClass_k52wcs_a0a2a0 {
    public QuotationClass_k52wcs_a0a2a0() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_k52wcs_a0a2a0 = null;
      {
        quotedNode_k52wcs_a0a2a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.PeriodType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_k52wcs_a0a2a0 = quotedNode_k52wcs_a0a2a0;
        result = quotedNode1_k52wcs_a0a2a0;
      }
      return result;
    }
