...
public class DateTimePropetyReferenceOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_5020_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_5020_0");
    editorCell.addEditorCell(this.createRefCell_5020_0(context, node));
    return editorCell;
  }

  private EditorCell createRefCell_5020_0(EditorContext context, SNode node) {
  ...
  public static class _Inline5020_0 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.createProperty_5020_0(context, node);
    }

    private EditorCell createProperty_5020_0(EditorContext context, SNode node) {
