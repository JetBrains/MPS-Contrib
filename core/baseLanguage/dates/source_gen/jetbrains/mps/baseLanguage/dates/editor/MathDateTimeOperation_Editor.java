...
public class MathDateTimeOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConstant_5464_0(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_5464_0(editorCell, node, context);
  ...
  public EditorCell createConceptProperty_5464_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_ConceptProperty_5464_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  public EditorCell createRefNode_5464_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_5464_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
  ...
  public EditorCell createRefNode_5464_2_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_5464_1((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
  ...
  private static void setupLabel_ConceptProperty_5464_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_RefNode_5464_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_5464_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_RefNode_5464_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
