...
public class ParseDateTimeExpression_Behavior {
  ...
  public static class QuotationClass_b1835x_a0a0b0a0b {
    ...
    public SNode createNode() {
      ...
      SNode quotedNode_b1835x_a0a0b0a0a = null;
      {
        quotedNode_b1835x_a0a0b0a0a = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.DateTimeZoneType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_b1835x_a0a0b0a0a = quotedNode_b1835x_a0a0b0a0a;
        result = quotedNode1_b1835x_a0a0b0a0a;
      }
      return result;
    }
  }
  ...
  public static class QuotationClass_b1835x_a0a0a0c {
    ...
    public SNode createNode() {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_b1835x_a0a0a0b = null;
      {
        quotedNode_b1835x_a0a0a0b = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.DateTimeZoneType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_b1835x_a0a0a0b = quotedNode_b1835x_a0a0a0b;
        result = quotedNode1_b1835x_a0a0a0b;
      }
      return result;
    }
  }
