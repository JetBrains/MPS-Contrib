...
public class DateTypeUtil {
  public static SNode dateTimeType = new QuotationClass_0().createNode();
  public static SNode periodType = new QuotationClass_1().createNode();
  public static SNode intType = new QuotationClass_2().createNode();
  public static SNode javaDateType = new QuotationClass_3().createNode();
  public static SNode javaCalendarType = new QuotationClass_4().createNode();
  public static SNode jodaAbstractInstant = new QuotationClass_5().createNode();
