  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1213195725472", true), (SNode)new _Quotations.QuotationClass_18().createNode(typeCheckingContext), _info_12389875345);
    }
    {
    ...
    }
    {
      ...
      _info_12389875345.setInequationGroup("default");
      typeCheckingContext.createLessThanInequation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "1213195725488", true), (SNode)new _Quotations.QuotationClass_20().createNode(typeCheckingContext), false, _info_12389875345);
    }
  }
