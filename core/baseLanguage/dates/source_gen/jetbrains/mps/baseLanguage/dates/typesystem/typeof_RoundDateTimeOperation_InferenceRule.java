...
public class typeof_RoundDateTimeOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext) {
    ...
    }
    {
      ...
      typeCheckingContext.createLessThanInequation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903d1(jetbrains.mps.baseLanguage.dates.typesystem)", "5488841840788545324", true), (SNode) new typeof_RoundDateTimeOperation_InferenceRule.QuotationClass_ykldpd_a0a1a0().createNode(typeCheckingContext), true, _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_ykldpd_a0a1a0 {
    public QuotationClass_ykldpd_a0a1a0() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_ykldpd_a0a1a0 = null;
      {
        quotedNode_ykldpd_a0a1a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.DateTimeWithTZType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_ykldpd_a0a1a0 = quotedNode_ykldpd_a0a1a0;
        result = quotedNode1_ykldpd_a0a1a0;
      }
      return result;
    }
