...
public class typeof_NeverExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_wu1r2e_a0a0a0 {
    public QuotationClass_wu1r2e_a0a0a0() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_wu1r2e_a0a0a0 = null;
      {
        quotedNode_wu1r2e_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.structure.DateTimeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_wu1r2e_a0a0a0 = quotedNode_wu1r2e_a0a0a0;
        result = quotedNode1_wu1r2e_a0a0a0;
      }
      return result;
    }
