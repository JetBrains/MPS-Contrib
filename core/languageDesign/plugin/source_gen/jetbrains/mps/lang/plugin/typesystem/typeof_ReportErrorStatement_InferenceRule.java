  ...
  public void applyRule(final SNode statement, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createLessThanInequationStrong((SNode)typeCheckingContext.typeOf(SLinkOperations.getTarget(statement, "error", true), "r:00000000-0000-4000-0000-011c89590364(jetbrains.mps.lang.plugin.typesystem)", "8821770403474038519", true), (SNode)new _Quotations.QuotationClass_31().createNode(typeCheckingContext), true, _info_12389875345);
    }
  }
