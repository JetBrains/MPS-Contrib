...
public class ExecutionConsoleStatement_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRefNode_2860_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
  ...
  public EditorCell createRefNode_2860_2_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
    EditorCell editorCell = provider.createEditorCell(context);
