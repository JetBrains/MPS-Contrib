...
public class RunConfigurationTypeDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_7369_5(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, RunConfigurationTypeDeclaration_Editor._QueryFunction_JComponent_4859441577819771929(node, context), "_4859441577819771928"));
    return editorCell;
  }
  ...
  public EditorCell createImage_7369_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_4859441577819771918(node, context));
  ...
  public static String _image_provider_4859441577819771918(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_4859441577819771929(SNode node, EditorContext editorContext) {
