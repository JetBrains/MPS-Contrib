...
public class RunConfigurationTypeDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_7369_5(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, RunConfigurationTypeDeclaration_Editor._QueryFunction_JComponent_5003188907305558305(node, context), "_5003188907305558304"));
    return editorCell;
  }
  ...
  public EditorCell createImage_7369_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_5003188907305558294(node, context));
  ...
  public static String _image_provider_5003188907305558294(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_5003188907305558305(SNode node, EditorContext editorContext) {
