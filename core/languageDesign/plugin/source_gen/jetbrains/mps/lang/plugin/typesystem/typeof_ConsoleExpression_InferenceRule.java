  ...
  public void applyRule(final SNode expression, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590364(jetbrains.mps.lang.plugin.typesystem)", "9061443648117368150", true), (SNode)new _Quotations.QuotationClass_35().createNode(typeCheckingContext), _info_12389875345);
    }
  }
