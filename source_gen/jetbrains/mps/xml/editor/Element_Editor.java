...
public class Element_Editor extends DefaultNodeEditor {
  ...
  public AbstractCellListHandler myAttributeListHandler_attributeList_;
  public AbstractCellListHandler myContentListHandler_contentList_;
  ...
  public EditorCell createAttributeList(EditorContext context, SNode node) {
    if(this.myAttributeListHandler_attributeList_ == null) {
      this.myAttributeListHandler_attributeList_ = new Element_Editor_AttributeListHandler_attributeList_(node, "attribute", context);
    }
  ...
  public EditorCell createContentList(EditorContext context, SNode node) {
    if(this.myContentListHandler_contentList_ == null) {
      this.myContentListHandler_contentList_ = new Element_Editor_ContentListHandler_contentList_(node, "content", context);
    }
