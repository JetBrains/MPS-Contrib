...
<model name="jetbrains.mps.baseLanguage.ext.dates.lang.actions">
  ...
  <node type="jetbrains.mps.bootstrap.actionsLanguage.RTransformHintSubstituteActions" id="1169657528660">
    ...
    <node role="actionsBuilder" type="jetbrains.mps.bootstrap.actionsLanguage.RTransformHintSubstituteActionsBuilder" id="1169657550853">
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1178205546357">
              <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1178205546358">
                <node role="expression" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1178205546359">
                  ...
                  <link role="baseMethodDeclaration" extResolveInfo="18.static method ([Classifier]CompareType).([StaticMethodDeclaration]getConstants())" />
                </node>
              </node>
            </node>
          </node>
                ...
                <node role="expression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1178374151104">
                  ...
                  <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Property_SetOperation" id="1178374152246">
                    <node role="value" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1178374173704">
                      <link role="baseMethodDeclaration" extResolveInfo="18.method ([Classifier]CompareType).([InstanceMethodDeclaration]getValueAsString())" />
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1178205546383">
              <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1178205546384">
                <node role="expression" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1178205546385">
                  <link role="baseMethodDeclaration" extResolveInfo="18.method ([Classifier]CompareType).([InstanceMethodDeclaration]getName())" />
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1178205546388">
              <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1178205546389">
                <node role="expression" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1178205546390">
                  <link role="baseMethodDeclaration" extResolveInfo="18.method ([Classifier]CompareType).([InstanceMethodDeclaration]getValue())" />
      ...
      <node role="part" type="jetbrains.mps.bootstrap.actionsLanguage.ConceptRightTransformPart" id="1182824758308">
      ...
      <node role="part" type="jetbrains.mps.bootstrap.actionsLanguage.ConceptRightTransformPart" id="1182824758311">
      ...
      <node role="part" type="jetbrains.mps.bootstrap.actionsLanguage.ConceptRightTransformPart" id="1182824758314">
      ...
      <node role="part" type="jetbrains.mps.bootstrap.actionsLanguage.ConceptRightTransformPart" id="1182824758317">
      ...
      <node role="part" type="jetbrains.mps.bootstrap.actionsLanguage.ConceptRightTransformPart" id="1182824758339">
    ...
    <node role="actionsBuilder" type="jetbrains.mps.bootstrap.actionsLanguage.RTransformHintSubstituteActionsBuilder" id="1171975030705">
      ...
      <node role="part" type="jetbrains.mps.bootstrap.actionsLanguage.ConceptRightTransformPart" id="1182824758320">
              ...
              <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1178203209685">
                <node role="expression" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1178203213734">
                  ...
                  <node role="actualArgument" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1178203220208">
                    <link role="baseMethodDeclaration" extResolveInfo="14.method ([Classifier]IOperationContext).([InstanceMethodDeclaration]getScope())" />
                  ...
                  <node role="actualArgument" type="jetbrains.mps.bootstrap.sharedConcepts.ConceptFunctionParameter_model" id="1182512548484" />
                </node>
              </node>
            </node>
          </node>
  ...
  <node type="jetbrains.mps.baseLanguage.ClassConcept" id="1171978333109">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1172502164825">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1185544585147">
          <node role="expression" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1185544670925">
            <link role="baseMethodDeclaration" extResolveInfo="23.static method ([Classifier]PeriodTypeHackUtil).([StaticMethodDeclaration]isInstanceOfPeriod((jetbrains.mps.baseLanguage.types.classifier/jetbrains.mps.baseLanguage.types.classifier [SNode])))" />
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1175768275799">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1175768275800">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1175768275802">
              <link role="baseMethodDeclaration" extResolveInfo="15.static method ([Classifier]TypeChecker).([StaticMethodDeclaration]getInstance())" />
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1175768471526">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1175768471527">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1175768482751">
              <link role="baseMethodDeclaration" extResolveInfo="15.method ([Classifier]TypeChecker).([InstanceMethodDeclaration]getSubtypingManager())" />
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1175768275803">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1175768275804">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1175768290920">
              <link role="baseMethodDeclaration" extResolveInfo="15.method ([Classifier]TypeChecker).([InstanceMethodDeclaration]hackTypeOf((jetbrains.mps.baseLanguage.types.classifier/jetbrains.mps.baseLanguage.types.classifier [SNode])))" />
    ...
    <node role="staticMethod" type="jetbrains.mps.baseLanguage.StaticMethodDeclaration" id="1175768616289">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1175768616291">
        <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1180023105796">
          <node role="expression" type="jetbrains.mps.bootstrap.helgins.IsStrongSubtypeExpression" id="1180023149876">
            <node role="subtypeExpression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1180023157557">
              <node role="nodeOperation" type="jetbrains.mps.bootstrap.helgins.Node_TypeOperation" id="1180023159181" />
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.ParameterReference" id="1180023155697">
                <link role="variableDeclaration" targetNodeId="1175768643167" resolveInfo="node" />
              </node>
            </node>
            <node role="supertypeExpression" type="jetbrains.mps.baseLanguage.ParameterReference" id="1180023165562">
    ...
    <node role="staticMethod" type="jetbrains.mps.baseLanguage.StaticMethodDeclaration" id="1178202857719">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1178202857721">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1182510413976">
          <node role="expression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1182510415052">
            <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Model_NodesIncludingImportedOperation" id="1182512066725">
              <link role="concept" targetNodeId="19.1172074318583" />
              <node role="scope" type="jetbrains.mps.baseLanguage.ParameterReference" id="1182512070729">
                <link role="variableDeclaration" targetNodeId="1178202882984" resolveInfo="scope" />
              </node>
            </node>
            <node role="leftExpression" type="jetbrains.mps.baseLanguage.ParameterReference" id="1182510413977">
      ...
      <node role="parameter" type="jetbrains.mps.baseLanguage.ParameterDeclaration" id="1182510399331">
        <property name="name" value="model" />
        <node role="type" type="jetbrains.mps.bootstrap.smodelLanguage.SModelType" id="1182510409005" />
      </node>
      <node role="visibility" type="jetbrains.mps.baseLanguage.PublicVisibility" id="1178546172424" />
    </node>
    <node role="visibility" type="jetbrains.mps.baseLanguage.PublicVisibility" id="1178550126504" />
  </node>
</model>
